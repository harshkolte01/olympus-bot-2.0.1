...
class NoPrefix(commands.Cog):
    ...
    async def np_add(self, ctx, user: discord.User):
        ...
        embed = discord.Embed(title="Select No Prefix Duration", description="**Choose the duration for how long no-prefix should be enabled for this user:**", color=0x00FFFF)
