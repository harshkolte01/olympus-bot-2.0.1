...
""")
    ...
    async def emergencysituation(self, ctx):
        ...
        processing_message = await ctx.send(embed=discord.Embed(title="<a:loading:1205135543071940639> Processing Emergency Situation, wait for a while...", color=0x00FFFF))
