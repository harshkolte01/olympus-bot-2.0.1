...
class Welcomer(commands.Cog):
    ...
    async def greet_reset(self, ctx):
        ...
        async def yes_button_callback(interaction):
            ...
            embed.title = "<a:emoji_1740993086003:1346047306230792204> Success"
    ...
    async def greet_channel(self, ctx):
        ...
        def generate_view(page):
            select_menu = Select(
                ...
                options=[
                    discord.SelectOption(label=channel.name, emoji="<:channel:1306576564229767239>", value=str(channel.id))
