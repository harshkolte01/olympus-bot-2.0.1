...
class Voice(commands.Cog):
    ...
    async def _kick(self, ctx, *, member: discord.Member):
        ...
        embed2 = discord.Embed(title="<a:emoji_1740993086003:1346047306230792204> Success",
    ...
    async def vcunmute(self, ctx, *, member: discord.Member):
        ...
        if member.voice.mute == False:
            embed2 = discord.Embed(title="<a:max_cross2:1346031247192883254> Error",
            ...
            return await ctx.reply(embed=embed2)
        ch = member.voice.channel.mention
        embed3 = discord.Embed(title="<a:emoji_1740993086003:1346047306230792204> Success",
    ...
    async def _moveall(self, ctx, *, channel: discord.VoiceChannel):
        ...
        try:
            ...
            embed3 = discord.Embed(title="<a:max_cross2:1346031247192883254> Error",
